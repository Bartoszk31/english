    ...
    return (
        <div className={styles.pageContainer}>
            <div className={styles.classSection}>
                ...
                <Link className={styles.linkButton} href={'/class-three/math/multiplication-one'}>{'Mnożenie 1'}</Link>
                <Link className={styles.linkButton} href={'/class-three/math/multiplication-two'}>{'Mnożenie 2'}</Link>
            </div>
